...
def evaluate_chat_model():
    ...
    for ds_name in args.datasets:
        ...
        outputs = []
        for _, (questions, images, conversations, question_ids, annotations) in tqdm(
            ...
            pred = model.chat(
                ...
                max_length=ds_collections[ds_name][
                    "max_new_tokens"
                ],  # TODO: how to use ds_collections[ds_name]['min_new_tokens']
            )
            pred_orig = pred
            if args.cot:
            ...
            for question_id, answer, annotation in zip(
                question_ids, answers, annotations
            ):
                outputs.append(
                    {
                        "question_id": question_id,
        ...
        if torch.distributed.get_rank() == 0:
            ...
            cmd = (
                "python eval/vlm/eval/pope/eval_pope.py "
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-path", type=str, default="../../../data/models/BAGEL-7B-MoT/"
    )
